...
namespace Group5Project.Controllers
{
    public class ValuesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "coreValueId,coreValueName")] CoreValues coreValues)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "coreValueId,coreValueName")] CoreValues coreValues)
        {
            if (ModelState.IsValid)
            {
